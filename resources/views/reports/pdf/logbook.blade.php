...
<body>
    ...
    <div>
        <center>
            <h1>CPSU FITNESS LAB USER'S LOGBOOK</h1>
        </center>
    </div>
    <div>
        <table style="border: 1px solid black; border-collapse: collapse; width: 100%;">
            <thead>
                <tr>
                    ...
                    <th style="border: 1px solid black; padding: 15px; font-size: 20px; font-family: Arial;">Full Name
                    </th>
                    <th style="border: 1px solid black; padding: 15px; font-size: 20px; font-family: Arial;">ID</th>
                    <th style="border: 1px solid black; padding: 15px; font-size: 20px; font-family: Arial;">Remarks
                    </th>
                </tr>
            </thead>
            <tbody>
